...
## Project Structure
    ...
    ├── testapiautodatamod_120114  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_120114`
...
2. Clone this repo and `cd testapiautodatamod_120114`
